...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
       ...
       $sql_upload ="INSERT INTO  areas_escolares (id_area_escolar, area_escolar) VALUES (2,'$target_file')";        //guarda la ruta completa
       // $sql_upload ="INSERT INTO  areas_escolares (id_area_escolar, area_escolar) VALUES (2,'$nombre_archivo')";  //solo el nombre del archivo
	   $resultado = @mysqli_query($conexion,$sql_upload);
