...
//	var FechaAyer = new Date(Date.parse(new Date().toDateString())-1);
    ...
    function scwSetDefaultLanguage()
        {try
            ...
            {// Español
             ...
             scwInvalidDateMsg      = 'La fecha de entrada no es válida. ';
             scwOutOfRangeMsg       = 'La fecha de entrada está fuera de alcance. ';
             scwDoesNotExistMsg     = 'La fecha de entrada no existe. ';
             scwInvalidAlert        = ['Fecha no válida (',') ignorada.'];
             scwDateDisablingError  = ['Error ',' no es un objeto Fecha.'];
             scwRangeDisablingError = ['Error ',' debe constar de dos elementos.'];
            }
        };
...
//	    scwDisabledDates[0] = new Date(2009,11,31);
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            'td.scwCellsExMonth         {background-color:  #FFFFFF;'   +
                                        'color:             #000000;}'  +
            '/* Today selector */'                                      +
            'td.scwFoot                 {background-color:  #CEE3F6;'   +
                                        'color:             #000000;}'  +
...
// ***************************
    ...
    document.write(
     ...
     "</iframe>" +
     "<table id='scw' class='scw' cellspacing='0' cellpadding='0'>" +
       "<tr class='scw'>" +
         "<td class='scw'>" +
